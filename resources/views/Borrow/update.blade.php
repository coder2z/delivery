...
<div class="x-body">
    <form class="layui-form" onsubmit="return false;" id="form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="enddate" name="enddate" required="" lay-verify="required|nonull"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use(['form', 'layer'], function () {
        ...
        form.verify({
            ...
            number1: [/^(?!0)(?:[0-9]{1,3}|1000)$/,'请输入0-1000的正整数']
        });
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $("#goods").attr("value",data.goods);
                $("#rangs_id option[value="+data.rangs_id+"]").prop("selected",true);
                $("#specifications").attr("value",data.specifications);
                $("#number").attr("value",data.number);
                $("#sale").attr("value",data.sale);
